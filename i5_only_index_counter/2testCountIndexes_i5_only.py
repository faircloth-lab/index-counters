...
print
print "You are now searching the file 2TestSeqs.fastq.gz"
print

#Change the Undetermined fileName 2 lines below this line!!!
barcode_combo_count = Counter()
with gzip.open('2TestSeqs.fastq.gz', 'rb') as infile:
    for line in infile:
        if line.startswith('@'):
            ls =line.strip().split(' ')
            barcodes = ls[-1]
...
print "Here is the sum of all sequences in the file with dual barcodes:"
print sum(barcode_combo_count.values())
print

#print the most common 50 barcodes - comment the next line if you don't want to see it
print "Here are the 50 most common barcode combinations in the file:"
print
